class User < ApplicationRecord
  ...
  devise :database_authenticatable, :registerable,
         ...
         validates :name_last_kanji, presence: true, format: { with: /\A[^ぁ-んァ-ヶー－a-zA-Z0-9]+\z/, message: 'is invalid. Input full-width characters' }
         validates :name_first_kanji, presence: true, format: { with: /\A[^ぁ-んァ-ヶー－a-zA-Z0-9]+\z/, message: 'is invalid. Input full-width characters' }
